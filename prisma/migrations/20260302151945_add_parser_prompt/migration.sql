...
CREATE TABLE "ParserPrompt" (
    ...
    CONSTRAINT "ParserPrompt_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "ParserPrompt_name_key" ON "ParserPrompt"("name");

-- Seed: v4_master prompt (active by default)
INSERT INTO "ParserPrompt" ("id", "name", "text", "isActive", "createdAt", "updatedAt")
VALUES (
  gen_random_uuid()::text,
  'v4_master',
  'You are an expert document parser specialized in endurance training plans.
